...
if not DEBUG:
    ...
    MINIO_STORAGE_MEDIA_BUCKET_NAME = (
        f"{os.getenv('MINIO_BUCKET')}-media" if os.getenv("MINIO_BUCKET") != "" else "shadowmere-media"
    )
    MINIO_STORAGE_AUTO_CREATE_MEDIA_BUCKET = True
    MINIO_STORAGE_STATIC_BUCKET_NAME = (
        f"{os.getenv('MINIO_BUCKET')}-static" if os.getenv("MINIO_BUCKET") != "" else "shadowmere-static"
    )
